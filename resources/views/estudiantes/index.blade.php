            ...
            @foreach ($estudiantes as $docente)
                <tr>
                    ...
                    <td>
                        <table>
                            <td>
                                <a href="{{ route('estudiantes.edit', $docente->id) }}" class="btn btn-warning">Editar</a>
                            </td>
                            <td>
                                <a href="{{ route('estudiantes.show', $docente->id) }}" class="btn btn-info">Ver</a>
                            </td>
                            <td>
                                <a href="{{ route('estudiantes.delete', $docente->id) }}" class="btn btn-danger">Eliminar</a>
                            </td>
                        </table>
